        ...
        <div className="glass p-6 sm:p-10 rounded-3xl shadow-2xl glow">
          ...
          {result && (
            <div className="mt-6 sm:mt-8 animate-in fade-in slide-in-from-bottom-4 duration-500">
              <div className="glass p-5 sm:p-6 rounded-2xl border-l-4 border-cyan-500">
                <div className="flex items-start gap-3 mb-4">
                  <svg
                    className="w-5 h-5 sm:w-6 sm:h-6 text-cyan-600 flex-shrink-0 mt-1"
                    fill="currentColor"
                    viewBox="0 0 20 20"
                  >
                    <path
                  ...
                  <div className="flex-1">
                    <h3 className="text-xs sm:text-sm font-bold text-slate-600 uppercase tracking-wider mb-2">
                      The True Cost:
                    </h3>
                    <p className="text-2xl sm:text-4xl font-black bg-gradient-to-r from-cyan-600 to-blue-600 bg-clip-text text-transparent">
        ...
        <div className="mt-6 sm:mt-8 glass px-4 sm:px-6 py-3 sm:py-4 rounded-xl shadow-lg">
          <div className="flex items-start gap-2 sm:gap-3">
            ...
            <div className="text-[10px] sm:text-xs text-slate-600 leading-relaxed">
              ...
              <p>
                This calculator shows you how many hours of work a purchase
                requires. Based on your monthly income and weekly working hours,
                it calculates your true hourly wage and converts any price into
                <strong className="text-cyan-700"> life hours</strong>.
              </p>
            </div>
          </div>
        </div>
